...
import 'agendar_atividade_model.dart';
export 'agendar_atividade_model.dart';

class AgendarAtividadeWidget extends StatefulWidget {
  const AgendarAtividadeWidget({super.key});

  @override
  State<AgendarAtividadeWidget> createState() => _AgendarAtividadeWidgetState();
}

class _AgendarAtividadeWidgetState extends State<AgendarAtividadeWidget>
    with TickerProviderStateMixin {
  late AgendarAtividadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendarAtividadeModel());
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          '03k0oj0u' /* Nome da Atividade */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'gfus5mj9' /* Escolha uma atividade ... */,
                                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'lp6p9nx4' /* Responsavel pela atividade */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'kvvxfukh' /* Escolha o responsavel pelo pro... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'qrtiulbt' /* Local da realização */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'j2wb5xwv' /* Digite o local e/ou endereço  ... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
