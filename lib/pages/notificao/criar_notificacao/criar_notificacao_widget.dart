                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'aenuwge1' /* Vamos começar preenchendo o fo... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'h4bs2pwg' /* Titulo da notificação */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'ibny2gb9' /* Digite o titulo da notificação... */,
                                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.textFieldEditEmailFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'szrugv9i' /* Texto da notificação */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'u81rq4y3' /* Escreva o texto ... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                  ...
                                  if (_model.radioButtonValue1 == 'Não')
                                    Row(
                                      mainAxisSize: MainAxisSize.min,
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceAround,
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ffhl92pb' /* Escolha para quem enviar: */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
