                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'facxmp0g' /* Digite a senha atual e depois ... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .passwordCurrentTextController,
                                        focusNode:
                                            _model.passwordCurrentFocusNode,
                                        autofocus: true,
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .passwordNewConfirmTextController,
                                        focusNode:
                                            _model.passwordNewConfirmFocusNode,
                                        autofocus: true,
                                        autofillHints: const [AutofillHints.password],
                                        obscureText: !_model
                                        ...
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            'wem15vrw' /* Confirme a nova senha */,
                                          ),
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelLarge
