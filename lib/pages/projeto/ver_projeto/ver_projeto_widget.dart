...
import 'ver_projeto_model.dart';
export 'ver_projeto_model.dart';

class VerProjetoWidget extends StatefulWidget {
  const VerProjetoWidget({super.key});

  @override
  State<VerProjetoWidget> createState() => _VerProjetoWidgetState();
}
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'zwgo3od9' /* Responsavel: Emily Rambo */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '2xrj9iur' /* Oferecemos aulas gratuitas par... */,
                                                    ),
                                                    textAlign: TextAlign.center,
                                                    maxLines: 10,
                                                    style: FlutterFlowTheme.of(
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            ...
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'ozgxmdjq' /* Solicitar participação */,
                                            ),
